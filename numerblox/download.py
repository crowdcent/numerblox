...
__all__ = ['BaseIO', 'BaseDownloader', 'NumeraiClassicDownloader', 'KaggleDownloader', 'PandasDataReadDownloader',
...
# Cell
class PandasDataReadDownloader(BaseDownloader):
    """
    Download financial data using Pandas Datareader.

    :param directory_path: Base folder to download files to. \n
    :param tickers: list of tickers used for Numerai Signals. \n
